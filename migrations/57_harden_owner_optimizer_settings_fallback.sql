-- ============================================================================
-- HARDEN OWNER OPTIMIZER SETTINGS FALLBACK
-- ============================================================================
-- get_owner_route_optimizer() previously cross-joined a LIMIT 1 row from
-- global_game_settings. If the table was empty, the optimizer returned no rows
-- without error. This migration guarantees a single fallback settings row.
-- ============================================================================
...
'Returns ranked route, fare, and cabin-layout opportunities for the owner with resilient player-relation and settings fallback resolution.';
