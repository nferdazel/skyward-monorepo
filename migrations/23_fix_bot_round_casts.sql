-- ============================================================================
-- SKYWARD BOT ROUND CAST FIX
-- ============================================================================
-- Follow-up for migration 22.
-- process_simulation_delta() invokes execute_bot_decisions(), and the bot
-- route-pricing branch must not call ROUND(double precision, integer).
-- PostgreSQL only supports the scale argument for NUMERIC, so we cast the
-- derived pricing expressions explicitly.
-- ============================================================================
