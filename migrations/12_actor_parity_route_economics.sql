-- ============================================================================
-- Migration 12: Actor parity — route economics and season scoping
-- Goal:
--   align bot route economics with player route economics for elapsed-time
--   scaling, airport demand treatment, and season scoping.
-- ============================================================================
