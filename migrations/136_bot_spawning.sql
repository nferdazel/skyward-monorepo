-- ============================================================================
-- Migration 136: Dynamic Bot Spawning
-- ============================================================================
-- Problem:
--   If all bots go bankrupt, the game has zero AI competitors permanently.
--   There's no mechanism to replace dead bots.
--
-- Fix:
--   1. Create spawn_bot() — creates a new AI user with random archetype & HQ
--   2. Modify execute_bot_decisions() — spawn replacement after daily decisions
--   3. Create get_bot_health() — admin diagnostic for bot population
-- ============================================================================
...
-- ============================================================================
-- Part 1: spawn_bot() — Creates a fresh AI competitor
-- ============================================================================
...
BEGIN
    ...
    -- Create bot user (trg_create_default_bank_account trigger will auto-create
    -- the operating bank account with starting_cash balance)
    INSERT INTO users (
        ...
        v_username,
        v_archetype || ' Airways ' || right(v_username, 4),
        'CEO ' || v_username,
        'AI',
        v_hq,
        v_game_time,
    ...
    RAISE NOTICE 'Spawned bot % with archetype % at HQ %', v_username, v_archetype, v_hq;
    RETURN v_bot_id;
END;
$$;
...
-- ============================================================================
-- Part 2: Add spawn_bot() call to execute_bot_decisions()
-- ============================================================================
...
-- ============================================================================
-- Part 3: get_bot_health() — Admin diagnostic view
-- ============================================================================
