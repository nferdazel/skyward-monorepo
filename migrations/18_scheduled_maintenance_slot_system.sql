-- ============================================================================
-- SKYWARD SCHEDULED MAINTENANCE SLOT SYSTEM
-- ============================================================================
-- Introduces weekly slack-hour maintenance recovery for scheduled aircraft,
-- aligns manual repair pricing with the client model, and hardens grounded
-- protection with the global 30% absolute safety floor.
-- ============================================================================
