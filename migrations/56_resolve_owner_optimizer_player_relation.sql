-- ============================================================================
-- RESOLVE OWNER OPTIMIZER PLAYER RELATION DYNAMICALLY
-- ============================================================================
-- Some live environments do not expose the player relation as public.users.
-- This migration makes get_owner_route_optimizer() discover the relation at
-- runtime by looking for a table or view with id + hq_airport_iata columns.
-- ============================================================================
...
'Returns ranked route, fare, and cabin-layout opportunities for the owner using runtime player-relation discovery.';
