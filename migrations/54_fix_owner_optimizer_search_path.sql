-- ============================================================================
-- FIX OWNER OPTIMIZER SEARCH PATH
-- ============================================================================
-- Recreates get_owner_route_optimizer() with an explicit SECURITY DEFINER
-- search path so public tables/functions resolve consistently in SQL Editor.
-- ============================================================================
