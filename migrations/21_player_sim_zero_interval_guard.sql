-- ============================================================================
-- Migration 21: Player simulation zero-interval guard
-- Goal:
--   stop route simulation from writing zero-amount bank ledger rows when
--   process_player_simulation_to_time() is called with no positive elapsed
--   game-time interval.
-- ============================================================================
